...
const DAYS = [
 ...
 { day:"7/3", title:"샤크길 · Hjörleifshöfði(흑사장) · 레이니스피아라 · 디르홀레이", color:"#f58231", drive:"운전 ~2h35m · 135km", stay:"Skógar Studio Apt (연박 2/2)",
   ...
   trails:[
     {nm:"Þakgil — Remundargil 루프 (보라색 · 추천)", st:"≈12.5km · 고도 250m · 3~5h · 중급",
      ...
      tp:"💡 등산 스틱 필수, 오전 출발. ⚠️ Vatnsrásarhöfuð 연장 변형은 '25 여름부터 일부 비공식 → 캠프장에서 현재 상태 확인.",
      links:[{t:"AllTrails",u:"https://www.alltrails.com/trail/iceland/southern/thakgil-remundargil-vatnsrasarhofud"},{t:"가이드",u:"https://thephotohikes.com/thakgil-hiking-and-camping/"}]},
     {nm:"Þakgil — 다른 루프", st:"빨강 Mælifell ≈13.5km·400~500m·4~5h  /  노랑 Austurafrétta ≈17km·6~8h",
      ds:"빨강: Mælifell 정상 + Mýrdalsjökull 빙하 파노라마. 노랑: 능선·계곡 장거리(체력 좋은 분).",
 ...
 { day:"7/4", title:"Vík → ⚠️F208 → 엘드가우 → 란드만 트레킹 ① → Highland Center", color:"#ffe119", drive:"운전 실제 ~5h · 180km", stay:"하이랜드 센터(확정)",
   ...
   trails:[
     ...
     {nm:"대안 (악천후·매우 피곤) — Frostastaðavatn 호수 루프", st:"≈7.5km 루프 · 고도 ~150m · 1.5~2.5h · 쉬움",
 ...
 { day:"7/6", title:"굴포스 → ⚠️F35 → 컬링가프욜", color:"#3cb44b", drive:"운전 ~2h30m · 110km", stay:"highland base(확정)",
   ...
   trails:[
     {nm:"흐베라달리(Hveradalir) 지열지대", st:"≈3km · 1.5~2h · 중급",
 ...
 { day:"7/9", title:"헹기포스 → 슈트를라길 → 스톡스네스(저녁) → 회픈(Holmur)", color:"#911eb4", drive:"운전 ~6h · 약 400km · 긴 날", stay:"Holmur (Höfn)",
   ...
   trails:[
     ...
     {nm:"슈트를라길(Stuðlagil) — East Side", st:"상단 유료주차(≈1,000 ISK) 편도 30분 / 하단 편도 1h",
 ...
 { day:"7/10", title:"회픈 → 요쿨살론 → 다이아몬드비치 → Múlagljúfur → 스카프타펠 → 프얄살론", color:"#f032e6", drive:"운전 ~4h30m · 약 290km · 긴 날", stay:"Skógar 근처",
   ...
   trails:[
     {nm:"⭐ Múlagljúfur(물라글류퓌르) 협곡 트레킹", st:"≈3~4km 왕복 · 1.5~2h · 중급(진흙·오르막)",
